...
WATCH_FILES=("$SCENE_FILE" "layout_config.py" "suneung_problems.py" "calculus_visualization.py" "manim_kit/graph.py" "manim_kit/substitution.py" "manim_kit/latex.py" "manim_kit/input_parser.py" "examples/suneung2.dsl.txt")
